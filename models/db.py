...
db.define_table("genes_1_10",Field("id_code", "string",label="کدملی", writable=False),*genes[0:110],migrate = False)
db.define_table("genes_11_20",Field("id_code", "string",label="کدملی", writable=False),*genes[110:220],migrate = False)
db.define_table("genes_21_30",Field("id_code", "string",label="کدملی", writable=False),*genes[220:330],migrate = False)
db.define_table("genes_31_40",Field("id_code", "string",label="کدملی", writable=False),*genes[330:440],migrate = False)
db.define_table("genes_41_50",Field("id_code", "string",label="کدملی", writable=False),*genes[440:550],migrate = False)
db.define_table("genes_51_60",Field("id_code", "string",label="کدملی", writable=False),*genes[550:660],migrate = False)
db.define_table("genes_61_70",Field("id_code", "string",label="کدملی", writable=False),*genes[660:770],migrate = False)
db.define_table("genes_71_80",Field("id_code", "string",label="کدملی", writable=False),*genes[770:880],migrate = False)
db.define_table("genes_81_90",Field("id_code", "string",label="کدملی", writable=False),*genes[880:990],migrate = False)
db.define_table("genes_91_100",Field("id_code", "string",label="کدملی", writable=False),*genes[990:1100],migrate = False)